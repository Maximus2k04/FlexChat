    ...
    public partial class SeedingData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "CreatedAt", "DefaultValue", "Description", "DisplayName", "IsRequired", "Key", "PropertyType" },
                values: new object[,]
                {
                    { 1, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "#4f46e5", "Background color for sender message bubbles", "Sender Bubble Background Color", true, "senderChatBubbleBgColor", "color" },
                    { 2, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "#ffffff", "Text color for sender message bubbles", "Sender Bubble Text Color", true, "senderChatBubbleTextColor", "color" },
                    { 3, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "18", "Border radius for sender message bubbles", "Sender Bubble Border Radius", false, "senderChatBubbleRadius", "number" },
                    { 4, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "#f3f4f6", "Background color for receiver message bubbles", "Receiver Bubble Background Color", true, "receiverChatBubbleBgColor", "color" },
                    { 5, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "#111827", "Text color for receiver message bubbles", "Receiver Bubble Text Color", true, "receiverChatBubbleTextColor", "color" },
                    { 6, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "18", "Border radius for receiver message bubbles", "Receiver Bubble Border Radius", false, "receiverChatBubbleRadius", "number" },
                    { 7, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "#ffffff", "Background color for chat header", "Header Background Color", true, "headerColor", "color" },
                    { 8, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "#111827", "Text color for chat header", "Header Text Color", true, "headerTextColor", "color" },
                    { 9, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "#f9fafb", "Background color for chat area", "Chat Background Color", true, "chatBackgroundColor", "color" },
                    { 10, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "#111827", "Text color in chat area", "Chat Text Color", true, "chatBackgroundTextColor", "color" },
                    { 11, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "#ffffff", "Background color for message input field", "Message Input Background Color", true, "messageInputBgColor", "color" },
                    { 12, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "#111827", "Text color for message input field", "Message Input Text Color", true, "messageInputTextColor", "color" },
                    { 13, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "12", "Border radius for message input field", "Message Input Border Radius", false, "messageInputRadius", "number" },
                    { 14, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "#4f46e5", "Background color for send button", "Send Button Background Color", true, "sendButtonBgColor", "color" },
                    { 15, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "#ffffff", "Arrow/icon color for send button", "Send Button Arrow Color", true, "sendButtonArrowColor", "color" },
                    { 16, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "6", "Border radius for send button", "Send Button Border Radius", false, "sendButtonRadius", "number" }
                });
